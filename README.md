...
- **请注意:**在本网页展示的演示中，专家模型的功能是基于我们本地环境部署实现的。如果您希望在自己的项目中实现类似功能，可以在我们开源代码的基础上，选择前往如 HugeFacing 或 ModelScope 等平台获取预训练模型权重，或者自行准备数据集进行训练模型，亦或是通过配置框架中的专家模块API接口来集成服务。
